...
export declare class FloatingMenuComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<FloatingMenuComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FloatingMenuComponent, "ngx-editor-floating-menu", never, { "editor": "editor"; }, {}, never, ["*"]>;
}
