...
export declare class NgxEditorComponent implements ControlValueAccessor, OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgxEditorComponent, "ngx-editor", never, { "placeholder": "placeholder"; "outputFormat": "outputFormat"; "editor": "editor"; }, { "focusOut": "focusOut"; "focusIn": "focusIn"; }, never, ["*"]>;
}
