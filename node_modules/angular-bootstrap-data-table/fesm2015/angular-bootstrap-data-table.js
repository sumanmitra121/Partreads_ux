...
DataTableRow.ɵfac = function DataTableRow_Factory(t) { return new (t || DataTableRow)(ɵɵdirectiveInject(forwardRef(() => DataTable))); };
...
function DataTable_th_11_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("mousedown", function DataTable_th_11_span_6_Template_span_mousedown_0_listener($event) { ɵɵrestoreView(_r16); const column_r6 = ɵɵnextContext().$implicit; const _r7 = ɵɵreference(1); const ctx_r15 = ɵɵnextContext(); return ctx_r15.resizeColumnStart($event, column_r6, _r7); });
    ɵɵelementEnd();
} }
function DataTable_th_11_Template(rf, ctx) { if (rf & 1) {
    const _r19 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "th", 13, 14);
    ɵɵlistener("click", function DataTable_th_11_Template_th_click_0_listener($event) { ɵɵrestoreView(_r19); const column_r6 = ctx.$implicit; const ctx_r18 = ɵɵnextContext(); return ctx_r18.headerClicked(column_r6, $event); });
    ɵɵpipe(2, "px");
...
function DataTable_tbody_12_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("selectedChange", function DataTable_tbody_12_Template_tbody_selectedChange_0_listener() { ɵɵrestoreView(_r24); const _r22 = ɵɵreference(1); const ctx_r23 = ɵɵnextContext(); return ctx_r23.onRowSelectChanged(_r22); });
    ɵɵelementEnd();
} if (rf & 2) {
...
const _c0$3 = function (a0, a1) { return [a0, a1]; };
...
DataTablePagination.ɵfac = function DataTablePagination_Factory(t) { return new (t || DataTablePagination)(ɵɵdirectiveInject(forwardRef(() => DataTable))); };
DataTablePagination.ɵcmp = ɵɵdefineComponent({ type: DataTablePagination, selectors: [["data-table-pagination"]], decls: 33, vars: 18, consts: [[1, "pagination-box"], [1, "pagination-range"], [3, "textContent"], [1, "pagination-controllers"], [1, "pagination-limit"], [1, "input-group"], [1, "input-group-addon"], ["type", "number", "min", "1", "step", "1", 1, "form-control", 3, "ngModel", "blur", "keyup.enter", "keyup.esc"], ["limitInput", ""], [1, "pagination-pages"], [1, "btn", "btn-default", "pagination-firstpage", 3, "disabled", "click"], [1, "btn", "btn-default", "pagination-prevpage", 3, "disabled", "click"], [1, "pagination-page"], ["type", "number", "min", "1", "step", "1", 1, "form-control", 3, "max", "ngModel", "blur", "keyup.enter", "keyup.esc"], ["pageInput", ""], [1, "btn", "btn-default", "pagination-nextpage", 3, "disabled", "click"], [1, "btn", "btn-default", "pagination-lastpage", 3, "disabled", "click"]], template: function DataTablePagination_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("blur", function DataTablePagination_Template_input_blur_14_listener() { ɵɵrestoreView(_r2); const _r0 = ɵɵreference(15); return ctx.limit = _r0.value; })("keyup.enter", function DataTablePagination_Template_input_keyup_enter_14_listener() { ɵɵrestoreView(_r2); const _r0 = ɵɵreference(15); return ctx.limit = _r0.value; })("keyup.esc", function DataTablePagination_Template_input_keyup_esc_14_listener() { ɵɵrestoreView(_r2); const _r0 = ɵɵreference(15); return _r0.value = ctx.limit; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵlistener("blur", function DataTablePagination_Template_input_blur_23_listener() { ɵɵrestoreView(_r2); const _r1 = ɵɵreference(24); return ctx.page = _r1.value; })("keyup.enter", function DataTablePagination_Template_input_keyup_enter_23_listener() { ɵɵrestoreView(_r2); const _r1 = ɵɵreference(24); return ctx.page = _r1.value; })("keyup.esc", function DataTablePagination_Template_input_keyup_esc_23_listener() { ɵɵrestoreView(_r2); const _r1 = ɵɵreference(24); return _r1.value = ctx.page; });
        ɵɵelementEnd();
...
function DataTableHeader_div_8_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function DataTableHeader_div_8_div_1_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r6); const ctx_r5 = ɵɵnextContext(2); return ctx_r5.dataTable.expandColumnVisible = $event; });
    ɵɵelementEnd();
...
function DataTableHeader_div_8_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "label");
    ɵɵelementStart(2, "input", 13);
    ɵɵlistener("ngModelChange", function DataTableHeader_div_8_div_2_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r8); const ctx_r7 = ɵɵnextContext(2); return ctx_r7.dataTable.indexColumnVisible = $event; });
    ɵɵelementEnd();
    ɵɵelementStart(3, "span");
    ɵɵtext(4);
    ɵɵelementEnd();
...
function DataTableHeader_div_8_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "label");
    ɵɵelementStart(2, "input", 13);
    ɵɵlistener("ngModelChange", function DataTableHeader_div_8_div_3_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r10); const ctx_r9 = ɵɵnextContext(2); return ctx_r9.dataTable.selectColumnVisible = $event; });
    ɵɵelementEnd();
    ɵɵelementStart(3, "span");
    ɵɵtext(4);
    ɵɵelementEnd();
...
function DataTableHeader_div_8_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "label");
    ɵɵelementStart(2, "input", 13);
    ɵɵlistener("ngModelChange", function DataTableHeader_div_8_div_4_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r13); const column_r11 = ctx.$implicit; return column_r11.visible = $event; });
    ɵɵelementEnd();
    ɵɵelement(3, "span", 15);
    ɵɵelementEnd();
    ɵɵelementEnd();
...
DataTableHeader.ɵfac = function DataTableHeader_Factory(t) { return new (t || DataTableHeader)(ɵɵdirectiveInject(forwardRef(() => DataTable))); };
